...
var formatHeaderSection = () => {
  ...
  if (tempoTimeWrapper) {
    const tempoAndTimeStrings = ((_f = (_e = $(".cproTempoTimeWrapper")) == null ? void 0 : _e.textContent) == null ? void 0 : _f.split("|").map((line) => line.trim())) || [];
    ...
    const timeString = tempoAndTimeStrings.find(
      (line) => line.includes("Taktart") || line.includes("Time") || line.includes("/")
    );
